...
class USBScriptTest(unittest.TestCase):
  ...
  def testGetBattOrs(self):
    bd = find_usb_devices.GetBusNumberToDeviceTreeMap()
    self.assertEqual(battor_device_mapping.GetBattOrList(bd),
  ...
  def testGetTTYDevices(self):
    ...
    result = list(pp)
    self.assertEqual(result[0], {7:'ttyUSB0',
                                  5:'ttyUSB1',
                                  3:'ttyUSB2',
                                  2:'ttyUSB5',
                                  1:'ttyUSB3'})
  ...
  def testGetPortDeviceMapping(self):
    ...
    result = list(pp)
    self.assertEqual(result[0], {7:(2, 21),
                                  5:(2, 22),
                                  3:(2, 24),
                                  2:(2, 26),
                                  1:(2, 25)})
  ...
  def testGetSerialMapping(self):
    ...
    result = list(pp)
    self.assertEqual(result[0], {7:'BattOr0',
                                  5:'BattOr1',
                                  3:'BattOr2',
                                  1:'BattOr3'})
  ...
  def testFastDeviceDescriptions(self):
    ...
    self.assertEqual(dev_battor_p7_h1_t0.desc,
  ...
  def testDeviceInformation(self):
    ...
    self.assertEqual(dev_battor_p7_h1_t0.info['id'], 2021)
  ...
  def testSerialNumber(self):
    ...
    self.assertEqual(dev_battor_p7_h1_t0.serial, 'BattOr0')
  ...
  def testBattOrDictMapping(self):
    ...
    self.assertEqual(a1, '/dev/ttyUSB1')
    self.assertEqual(a2, '/dev/ttyUSB2')
    self.assertEqual(a3, '/dev/ttyUSB3')
  ...
  def testReadSerialMapFile(self):
    ...
    self.assertEqual(len(list(map_dict.keys())), 3)
    self.assertEqual(map_dict['Phone1'], 'BattOr1')
    self.assertEqual(map_dict['Phone2'], 'BattOr2')
    self.assertEqual(map_dict['Phone3'], 'BattOr3')
