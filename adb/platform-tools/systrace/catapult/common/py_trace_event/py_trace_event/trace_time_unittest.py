...
class TimerTest(unittest.TestCase):
  ...
  def testGetClockGetTimeClockNumber_linux(self):
    self.assertEqual(trace_time.GetClockGetTimeClockNumber('linux'), 1)

  def testGetClockGetTimeClockNumber_freebsd(self):
    self.assertEqual(trace_time.GetClockGetTimeClockNumber('freebsd'), 4)

  def testGetClockGetTimeClockNumber_bsd(self):
    self.assertEqual(trace_time.GetClockGetTimeClockNumber('bsd'), 3)

  def testGetClockGetTimeClockNumber_sunos(self):
    self.assertEqual(trace_time.GetClockGetTimeClockNumber('sunos5'), 4)
