...
""")
    ...
    with fs:
      ...
      self.assertEqual([loader.loaded_modules['y'],
      ...
      self.assertEqual([loader.loaded_modules['z'],
...
""")
    ...
    with fs:
      ...
      self.assertEqual(['py_vulcanize.foo'], dep_names)
...
""")
    ...
    with fs:
      ...
      self.assertEqual(1, len(my_module.dependent_raw_scripts))
